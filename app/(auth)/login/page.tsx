      ...
      <Card className="w-full max-w-md border-zinc-800 bg-zinc-900 text-zinc-100 shadow-xl">
        ...
        <CardContent className="space-y-4">
          ...
          >
            ...
            {isLoading ? "Aguarde..." : "Login com o Google"}
          </Button>
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            <div className="space-y-2">
              ...
              <Input id="email" name="email" type="email" placeholder="seunome@exemplo.com" className="border-zinc-700 bg-zinc-950/50 text-zinc-100" required />
            </div>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="password" className="text-zinc-300">Senha</Label>
                <Link href="/forgot-password" className="text-xs text-emerald-400">Esqueceu a senha?</Link>
              </div>
              <Input id="password" name="password" type="password" className="border-zinc-700 bg-zinc-950/50 text-zinc-100" required placeholder="Digite sua senha" />
            </div>
            <Button type="submit" className="w-full bg-emerald-500 text-zinc-950 hover:bg-emerald-400" disabled={isLoading}>
              {isLoading ?
                <>
        ...
        <CardFooter className="flex flex-col gap-4 border-t border-zinc-800 pt-6">
          <p className="text-center text-xs text-zinc-500">
            Não tem uma conta? <Link href="/register" className="text-emerald-400 hover:underline">Cadastre-se</Link>
          </p>
        </CardFooter>
      </Card>
    </div>
